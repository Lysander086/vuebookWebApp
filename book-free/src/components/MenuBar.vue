        ...
        <div class="setting-progress" v-else-if="showTag === 2">
          <div class="progress-wrapper">
            <input class="progress" type="range"
                   ...
                   :value="progress"
                   :disabled="!parent.bookAvailable"
                   ref="progress">
          </div>
          <div class="text-wrapper">
            <span>{{parent.bookAvailable ? progress + '%' : '加载中...'}}</span>
          </div>
        </div>
      </div>
    </transition>
...
export default {
  mounted() {
    // console.log('MenuBar', this.bookAvailable)
    setTimeout(() => {
      // console.log('MenuBar 2', this.bookAvailable)
    }, 6000)
  },
